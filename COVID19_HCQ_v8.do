...
stcox i.arm2 age i.sex ib2.clinical
estat phtest
stphplot, by(arm)
...
stcox ib3.arm2 age i.sex //  ib2.clinical
estat phtest
stphplot, by(arm2) // fails PH, badly

* better option

// ssc install stpm2 

stpm2 ib3.arm2 age i.sex, knots(4) scale(haz) eform //  ib2.clinical
estat ic

outreg2 using "HCQ_2020_T3a.tex", ///
	replace sideway stats(coef ci pval) noaster dec(3) label tex eform
...
/*
stcurve, surv at1(arm2=1) at2(arm2=2) at3(arm2=3) // mean of other covariates
