...
*				PhB 23 Mar new code & edits
* 				AAL 28 Mar minor edits
*********************************************************************
...
stcurve, surv at1(arm2=1) at2(arm2=2) at3(arm2=3)
...
save "COVID19_HCQ_v7.dta", replace

******************************************************************
* Section V: Code by Philippe Bocquier
* To deal with: 
...
stphplot, by(arm2) adjust(age sex spell clinical) nonegative ///
...
stcurve, surv at1(arm2=1) at2(arm2=2) at3(arm2=3) lwidth(1.5 1.5 1.5) ///
		...
		xlabel(, angle(h) labsize(4)) ///
		ylabel(0(0.2)1.0, angle(h) format(%3.1f) labsize(5)) ///
		legend(order(3 1 2) col(1) stack ring(0) size(4) position(8)) ///
		title("") ///
		note("Data from Gautret {it:et al.} (2020) IJAA, DOI : 10.1016/j.ijantimicag.2020.105949", size(3) pos(12))

* results far from robust 
stcox ib1.arm if age>=20, vce(bootstrap, reps(1000)) // ib2.clinical Note: AAL added reps
stcox ib3.arm2 if age>=20, vce(bootstrap, reps(1000)) // ib2.clinical
stcox ib3.arm2 age i.sex ib0.spell if age>=20, vce(bootstrap, reps(1000)) // ib2.clinical
stcox ib3.arm2 ib2.agegroup i.sex ib0.spell if age>=20, vce(bootstrap, reps(1000)) // ib2.clinical
